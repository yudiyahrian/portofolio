    ...
    <>
      <header
        className={cn(
          ...
          scrolled
            ? "bg-white/95 dark:bg-dark-900/95 backdrop-blur-xs border-b-3 border-dark-700 dark:border-dark-600"
            : "bg-transparent"
        )}
        role="banner"
      >
        ...
        >
          ...
          <Link
            ...
            aria-label="Yudiya Portfolio - Home"
          >
            ...
            {siteConfig.nav.map((item) => {
              ...
              return (
                <Link
                  ...
                  role="menuitem"
                  className={cn(
                    "font-pixel text-[9px] px-3 py-2 transition-all duration-100 relative group",
                    isActive
                      ? "text-pixel-blue"
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              href="/resume"
              className="hidden sm:flex pixel-btn-primary items-center gap-1.5 text-[8px]"
            >
              <Download size={10} />
              RESUME
            </a>
        ...
        {isOpen && (
          <>
            ...
            >
              ...
              {/* Retro window buttons decorative */}
              <div className="px-4 py-2 bg-dark-800 border-b border-dark-700 flex gap-2">
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          ...
                          {item.label}
                          {isActive && (
                            <span className="ml-auto text-pixel-blue animate-pixel-blink">◀</span>
                          )}
                        </Link>
                      </motion.div>
                    );
              ...
              <div className="p-4 border-t-3 border-dark-700 space-y-3">
                <a
                  href="/resume"
                  className="pixel-btn-primary flex items-center justify-center gap-2 w-full text-[9px]"
                >
                  <Download size={12} />
                  DOWNLOAD RESUME
                </a>
                <div className="flex justify-center gap-4">
                  <a href={siteConfig.social.github} target="_blank" rel="noopener noreferrer"
                    className="text-slate-400 hover:text-pixel-blue transition-colors" aria-label="GitHub">
                    <TbBrandGithub size={18} />
                  </a>
                  <a href={siteConfig.social.twitter} target="_blank" rel="noopener noreferrer"
                    className="text-slate-400 hover:text-pixel-blue transition-colors" aria-label="Twitter">
                    <TbBrandTwitter size={18} />
                  </a>
                  <a href={siteConfig.social.linkedin} target="_blank" rel="noopener noreferrer"
                    className="text-slate-400 hover:text-pixel-blue transition-colors" aria-label="LinkedIn">
